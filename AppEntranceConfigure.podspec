#
#  Be sure to run `pod spec lint AppEntranceConfigure.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://www.devzou.com"
  ...
  s.author             = { "lianyu125" => "lianyu125@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/lianyu125/AppEntranceConfigure.git", :tag => "#{s.version}" }
